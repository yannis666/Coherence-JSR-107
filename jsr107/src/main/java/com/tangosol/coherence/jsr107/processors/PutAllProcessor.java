 ...
 * @since 1.0
 */
public class PutAllProcessor implements InvocableMap.EntryProcessor {
    private final Map<Binary, Binary> value; 

    public PutAllProcessor(Map<Binary, Binary> value) {
        this.value = value;
    }
